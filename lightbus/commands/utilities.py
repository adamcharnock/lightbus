...
class BusImportMixin(object):
    ...
    def setup_import_parameter(self, argument_group):
        ...
        group.add_argument(
            ...
            help=(
                "The Python module to import initially. Will autodetect if omitted. "
        ...
        group.add_argument(
            ...
            metavar="BUS_PATH",
            help=(
                "The path to the bus.py file. Will autodetect if omitted. "
    ...
    def import_bus(self, args):
        if args.imprt:
            ...
            if not spec:
                logger.critical(
                    "Could not find module '{}' as specified by --import. Ensure "
