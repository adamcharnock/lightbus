...
from lightbus.config.config import set_default_config
...
async def create_async(
    ...
    **kwargs,
    ...
    if isinstance(config, Mapping):
        ...
        # Specifying config as a RootConfig instance will disable inheritance
        # as we will not have access to the source config dict(/json) at this point.
        # This source is required for config inheritance to function.
        config = Config(config, source=None)
