...
class LightbusMetricsApi(Api):
    rpc_call_sent = Event(arguments=['process_name', 'rpc_id', 'api_name', 'rpc_name', 'kwargs', 'timestamp'])
    rpc_call_received = Event(arguments=['process_name', 'rpc_id', 'api_name', 'rpc_name', 'timestamp'])
    rpc_response_sent = Event(arguments=['process_name', 'rpc_id', 'api_name', 'rpc_name', 'response', 'timestamp'])
    rpc_response_received = Event(arguments=['process_name', 'rpc_id', 'api_name', 'rpc_name', 'timestamp'])
