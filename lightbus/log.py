...
default_formats = {
    "%": {
        "DEBUG": "%(log_color)s%(asctime)s %(name)s | %(msg)s",
        "INFO": "%(log_color)s%(asctime)s %(name)s | %(msg)s",
        "WARNING": "%(log_color)s%(asctime)s %(name)s | %(msg)s",
        "ERROR": "%(log_color)s%(asctime)s %(name)s | ERROR: %(msg)s (%(module)s:%(lineno)d)",
        "CRITICAL": "%(log_color)s%(asctime)s %(name)s | CRITICAL: %(msg)s",
    },
